...
data = enrich(study_areas=[{"sourceCountry":"US","layer":"US.States","ids":[
            '01',
            '02','04','05','06','08','09','10','12','13','15','16','17',
...
# Set USA ID to 999
macro_df.loc[macro_df['Geo_Type'] == 'US.WholeUSA', 'Geo_ID'] = '999'


# Get BLS Data and join on ESRI data
sql = sql_caller.SqlCaller(create_tables=True)
bls_unemployment_data = sql.db_get_BLS_data()
...
sql.db_dump_ESRI_unemployment_data(match[['Geo_ID', 'Geo_Name', 'Geo_Type', 'UnemploymentRate_ESRI','UnemploymentRate_BLS','Unemployment_multiplier']])
